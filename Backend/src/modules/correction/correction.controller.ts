 ...
 */
export const openCorrection = asyncHandler(async (req: Request, res: Response) => {
 ...
 */
export const getCorrectionProgress = asyncHandler(async (req: Request, res: Response) => {
  const sessionId = req.params.sessionId as string;
 ...
 */
export const getDiscrepancies = asyncHandler(async (req: Request, res: Response) => {
  const sessionId = req.params.sessionId as string;
 ...
 */
export const assignThirdCorrector = asyncHandler(async (req: Request, res: Response) => {
  const sessionId = req.params.sessionId as string;
 ...
 */
export const getPapersForSubject = asyncHandler(async (req: Request, res: Response) => {
  const subjectId = req.params.subjectId as string;
  const sessionId = req.query.sessionId as string | undefined;
  const correctorId = req.user!.id;

  if (!sessionId) {
    res.status(400).json({ success: false, message: "sessionId query param is required" });
    return;
  }
 ...
 * Body: { sessionId }
 */
export const submitGrades = asyncHandler(async (req: Request, res: Response) => {
  const subjectId = req.params.subjectId as string;
 ...
 */
export const getCopyDetail = asyncHandler(async (req: Request, res: Response) => {
  const copyId = req.params.copyId as string;
  const correctorId = req.user!.id;
