...
export default function CreateFormationModal({ onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-6 p-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              placeholder="Doctorat en Informatique"
        ...
        {/* Modal Footer */}
        <div
          className="flex flex-row justify-end items-center gap-3 px-8 py-6"
        >
          <button
            onClick={onClose}
