...
export default function StaffTab() {
  ...
  return (
    <div className="flex flex-col gap-8 w-full">
      ...
      {/* Correcteurs */}
      <SectionCard title="Correcteur" members={correctors} />

      {/* Jury */}
      <SectionCard title="Membres du jury" members={jury} />

      {/* Surveillants */}
      <SectionCard title="Surveillants" members={surveillants} />
    </div>
  );
}