            ...
            <div className="flex flex-col p-6 gap-5 shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1)] rounded-[12px] bg-white">
              ...
              <div className="w-full flex justify-end mt-2">
                <button
                  ...
                  disabled={
                    isLoading2 || !specializationName || !specializationCode
                  }
                  style={{
                    opacity:
                      isLoading2 || !specializationName || !specializationCode
              ...
              >
                ...
                {isLoadingSpecs ? (
                  <div className="flex items-center justify-center py-10">
                    <Loader2
                      size={20}
                      className="animate-spin text-[#5E39E0]"
                    />
                  </div>
                      ...
                      <div className="flex-[1] px-8 py-4 flex justify-end items-center gap-2">
                        ...
                        >
                          {isDeletingSpecId === spec.id ? (
                            ...
                            <Trash2
                              size={13}
                              className="text-[#474554] hover:text-red-500 transition-colors"
                            />
                          )}
                        </button>
                      </div>
                ...
                {specializations.length > 0 && (
                  <div className="flex flex-row justify-between items-center px-8 py-3 bg-[#F3F4F5] sticky bottom-0">
                    <span className="text-[12px] font-semibold text-[#474554] tracking-[0.6px]">
                      Showing {specializations.length} specialization
              ...
              {program.sessions && program.sessions.length > 0 ? (
                program.sessions.map((session) => (
                  <div
                    ...
                    onClick={() =>
                      router.push(
                        `/dashboard/admin/programs/${program.id}/${session.id}`,
                      )
                    }
                  >
