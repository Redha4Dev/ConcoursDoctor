...
export default function ProgramsPage() {
 ...
 const activeCount = programs.filter((p) => p.isActive === true).length;
  ...
  const filtered = programs.filter((p) => {
    if (filter === "Active") return p.isActive === true;
        ...
        >
            ...
            <div className="flex flex-col w-full">
              {filtered.map((program, i) => (
                <div
                  ...
                  style={{ height: 88 }}
                  onClick={() =>
                    router.push(`/dashboard/admin/programs/${program.id}`)
                  }
                >
                  {/* Name + icon */}
          ...
          <div className="flex flex-row justify-between items-center px-8 py-4 w-full bg-white border-t border-[#F8FAFC]">
            <span
              ...
              style={{ fontFamily: "'Google Sans', sans-serif" }}
            >
              Showing 1 to {filtered.length} of {programs.length}{" "}
              programs
            </span>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col gap-1">
              ...
              <p
                ...
                style={{ fontFamily: "'Google Sans', sans-serif" }}
              >
                Prepare the admission schedules for the Fall 2026 semester.
              </p>
              <button
          ...
          >
            ...
            <div className="mt-4 flex flex-col items-center gap-1 text-center">
              ...
              <span
                ...
                style={{ fontFamily: "'Google Sans', sans-serif" }}
              >
                The academic performance report is now available.
              </span>
            </div>
            <button
